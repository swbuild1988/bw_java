...
insert into T_EM_RELATED_UNIT (id, name, contact, tel, unit_type, address, section_ids, longitude, latitude, crt_time)
values (5, '山姆大叔会员店', '李娜', '18702563019', 4, '锦绣路190号', '[2],[4]', '112.49367103150836', '37.70647176505491', to_date('09-07-2018 13:16:23', 'dd-mm-yyyy hh24:mi:ss'));

insert into T_EM_RELATED_UNIT (id, name, contact, tel, unit_type, address, section_ids, longitude, latitude, crt_time)
values (6, '世纪公园', '井自豪', '18702563039', 6, '上海市浦东新区向城路80号', '[1],[9]', '112.494090', '37.706188', to_date('09-07-2018 13:17:55', 'dd-mm-yyyy hh24:mi:ss'));

insert into T_EM_RELATED_UNIT (id, name, contact, tel, unit_type, address, section_ids, longitude, latitude, crt_time)
values (7, '浦东国际机场', '胡志强', '(021)68347575', 6, '上海市浦东新区迎宾大道6000号', '[15]', '112.494082', '37.706135', to_date('09-07-2018 13:19:18', 'dd-mm-yyyy hh24:mi:ss'));
commit;
