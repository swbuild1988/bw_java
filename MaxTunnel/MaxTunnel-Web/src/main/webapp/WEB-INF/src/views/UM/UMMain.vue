    ...
    <div class="main" :style="{height:fullHeight+'px'}">
        ...
        <div class="modals">
            <Row type="flex" justify="center" align="top" class="code-row-bg">
                ...
                <Row class="rowTop">
                    <Col span="8">
                    <Button type="info" class="normalBtn" @click="goToMoudle({ path:'/UM/tunnelCustomer/list'})">
                        <div>
                    ...
                    <Col span="8">
                    <Button type="info" class="normalBtn" @click="goToMoudle({ path:'/UM/enterGalleryApplication/query'})">
                        <div>
                    ...
                    <Col span="8">
                    <Button class="normalBtn" type="primary" @click="goToMoudle({ path:'/UM/tunnelDocuments/list'})">
                        <div>
                ...
                <Row class="rowTop">
                    <Col span="8">
                    <Button class="normalBtn btn-quexian" type="primary" @click="goToMoudle({ path:'/UM/TunnelEnergy/homepage'})">
                        <div>
                    ...
                    <Col span="8">
                    <Button class="normalBtn" type="primary" @click="goToMoudle({ path:'/UM/tunnelContract/list'})">
                        <div>
                    ...
                    <Col span="8">
                    <Button class="normalBtn" type="primary" @click="goToMoudle({ path:'/UM/OperatingSpace/tunnel/1'})">
                        <div>
                ...
                <Row class="rowTop">
                    <Col span="8">
                    <Button class="normalBtn" type="primary" @click="goToMoudle({ path:'/UM/relatedUnits/query'})">
                        <div>
                            <img src="../../assets/UM/basicInfo.png" :width="imgWidth">
                ...
                <Row class="rowTop">
                    <Col span="8">
                    <Button type="info" class="normalBtn" @click="goToMoudle({ path:'/UM/TunnelSafety'})">
                        <div>
                ...
                <Row class="rowTop">
                    ...
                    <Col span="8">
                    <Button type="primary" class="normalBtn" @click="goToMoudle({ path:'/UM/DataAnalysis/QueryData'})">
                        <div>
                            <img src="../../assets/UM/dataAnalysis.png" :width="imgWidth">
                    ...
                    <Button type="primary" class="normalBtn" @click="goToMoudle({ path:'/UM/PersonnelPosition/tunnel'})">
                        <div>
                            <img src="../../assets/UM/position.png" :width="imgWidth">
                ...
                <Row class="rowTop">
                    <Col span="8">
                    <Button class="btn-nenghao normalBtn" style="box-shadow: 3px 3px 20px rgba(6, 6, 18, 0.7);" @click="goToMoudle({ path:'/UM/virtualInspect'})">
                        <div>
                    ...
                    <Col span="8">
                    <Button class="normalBtn" type="primary" @click="goToMoudle({ path:'/UM/equipment/homePage'})">
                        <div>
                    ...
                    <Col span="8">
                    <Button class="normalBtn" type="primary" @click="goToMoudle({ path:'/UM/patrolTask/query'})">
                        <div>
                ...
                <Row class="rowTop">
                    <Col span="8">
                    <Button class="normalBtn" type="primary" @click="goToMoudle({ path:'/UM/defect/query'})">
                        <div>
                    ...
                    <Col span="8">
                    <Button class="btn-yonhu normalBtn" @click="goToMoudle({ path:'/UM/plans/detial/FirePlanProcess'})">
                        <div>
                ...
                <Row class="rowTop">
                    <Col span="8">
                    <Button class="normalBtn btn-jiqiren" @click="goToMoudle({ path:'/VMMain2'})">
                        <div>
                            <img src="../../assets/UM/空间.png" :width="imgWidth">
                    ...
                    <Col span="8">
                    <Button class="normalBtn" type="primary" @click="goToMoudle({ path:'/UM/overhaul/query'})">
                        <div>
                            <img src="../../assets/UM/检修.png" :width="imgWidth">
                ...
                <Row style="margin-top: 16vh;">
                    ...
                    <span style="font-size: 2.4vmin">安全运营
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            updateTime() {
                this.nowTime = new Date().getHours() < 12 ? new Date().format("hh:mm:ss") :
                    new Date(new Date().getTime() - 60 * 60 * 1000 * 12).format("hh:mm:ss");
