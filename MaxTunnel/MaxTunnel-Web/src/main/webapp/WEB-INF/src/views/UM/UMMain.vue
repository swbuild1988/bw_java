                ...
                <Col span="6">
                    ...
                    <Col span="8">
                        <Button
                            type="info"
                            class="normalBtn"
                            :disabled="findPath('/UM/tunnelCustomer/list')?false:true"
                    ...
                    <Col span="8">
                        <Button
                            ...
                            type="info"
                            :disabled="findPath('/UM/TunnelEnergy/homepage')?false:true"
                    ...
                    <Col span="8">
                        <Button
                            class="normalBtn"
                            :disabled="findPath('/UM/tunnelContract/list')?false:true"
                            type="info"
                    ...
                    <Col span="8">
                        <Button
                            class="normalBtn"
                            type="info"
                            :disabled="findPath('/UM/OperatingSpace/tunnel')?false:true"
                    ...
                    <Col span="8">
                        <Button
                            class="normalBtn"
                            type="info"
                            :disabled="findPath('/UM/relatedUnits/query')?false:true"
                ...
                <Col span="6" offset="1">
                    ...
                    <Col span="8">
                        <Button
                            type="info"
                            class="normalBtn"
                            :disabled="findPath('/UM/TunnelSafety')?false:true"
                    ...
                    <Col span="16">
                        <Button
                            class="widthBtn btn-xunjian"
                            :disabled="findPath('/UM/TunnelEnvironment')?false:true"
                            @click="goToMoudle({ path:'/UM/TunnelEnvironment'})"
                        >
                            <div>
                                <img src="../../assets/UM/environment.png" :width="imgWidth">
                                <div
                                    :style="{fontSize:mySize,textAlign:'center',color: '#fff'}"
                                >环境监测</div>
                            </div>
                        </Button>
                    </Col>
                    ...
                    <Col span="8">
                        <Button
                            ...
                            :disabled="findPath('/UM/VideoMonitoring/details')?false:true"
                    ...
                    <Col span="8">
                        <Button
                            type="info"
                            class="normalBtn"
                            :disabled="findPath('/UM/DataAnalysis/QueryData')?false:true"
                    ...
                    <Col span="8">
                        <Button
                            type="info"
                            class="normalBtn"
                            :disabled="findPath('/UM/PersonnelPosition/Visitors')?false:true"
                ...
                <Col span="6" offset="1">
                    ...
                    <Col span="8">
                        <Button
                            class="normalBtn"
                            type="info"
                            :disabled="findPath('/UM/equipment/homePage')?false:true"
                    ...
                    <Col span="8">
                        <Button
                            class="normalBtn"
                            type="info"
                            :disabled="findPath('/UM/defect/query')?false:true"
                    ...
                    <Col span="8">
                        <Button
                            class="normalBtn"
                            :disabled="findPath('/UM/patrol/homePage')?false:true"
                    ...
                    <Col span="8">
                        <Button
                            ...
                            :disabled="findPath('/VMMain2')?false:true"
                    ...
                    <Col span="8">
                        <Button
                            class="normalBtn"
                            :disabled="findPath('/UM/overhaul/query')?false:true"
                            type="info"
