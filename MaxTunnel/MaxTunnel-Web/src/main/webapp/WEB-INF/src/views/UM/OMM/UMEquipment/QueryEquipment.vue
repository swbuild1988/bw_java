                                ...
                                >
                                    <div class="infoBox">
                                        ...
                                        <Row class="detailsBox">
                                            <Col
                                                span="12"
                                                :title="item.tunnel.name"
                                            >所属管廊：{{item.tunnel.name}}</Col>
                                            <Col
                                                span="12"
                                                :title="item.typeName"
                                            >设备类型：{{ item.typeName }}</Col>
                                            <Col
                                                span="12"
                                                :title="item.vender.name"
                                            >供应商：{{item.vender.name}}</Col>
                                            <Col
                                                span="12"
                                                :title="item.model.name"
                                            >所属型号：{{item.model.name}}</Col>
                                            <Col
                                                span="12"
                                                :title="item.statusName"
                                            >设备状态：{{item.statusName}}</Col>
                                            <Col
                                                span="12"
                                                :title="item.crtTime"
                                            >启用时间：{{ item.crtTime }}</Col>
                                        </Row>
                                        <div class="operation">
                                            <Row>
    ...
    data() {
        return {
            ...
            EquipmentHeader: [
                ...
                {label: '资产编码', prop: 'assetNo'},
                {label: '所属管廊', prop: 'tunnelId'},
                {label: '设备所属系统', prop: 'typeName'},
                {label: '设备状态', prop: 'statusName'},
                {label: '规格型号', prop: 'modelId'},
                {label: '量程', prop: 'range'},
                {label: '额定电压', prop: 'ratedVoltage'},
                {label: '质保期限', prop: 'qaTerm'},
                {label: '厂家', prop: 'factory'},
                {label: '品牌',prop: 'brand'},
                {label: '供应商', prop: 'venderId'},
                {label: '安装时间', prop: 'runTime'},
                {label: '安装位置', prop: 'sectionId'},
                {label: '关联设备', prop: 'objId'}
            ],
