            ...
            <Row class="conditions">
                <Col span="4">
                    ...
                    <Select v-model="conditions.finished" style="width: 60%">
                        ...
                        <Option
                            v-for="(item,index) in patrolResult"
                            :key="index"
                            :value="item.val"
                        >{{item.key}}</Option>
                    </Select>
...
export default {
                ...
                },
                {
                    ...
                    render: (h, params) => {
                        ...
                        if (temp == null) {
                            ...
                            temp = new Date(params.row.taskTime).format(
                                "yyyy-MM-dd"
                            );
                        }
                        return h("div", temp);
                ...
                },
                {
                    ...
                    render: (h, params) => {
                        ...
                        if (temp == null) {
                            ...
                            temp = new Date(params.row.startTime).format(
                                "yyyy-MM-dd hh:mm:s"
                            );
                        }
                        return h("div", temp);
                ...
                },
                {
                    ...
                    render: (h, params) => {
                        ...
                        if (temp == null) {
                            ...
                            temp = new Date(params.row.endTime).format(
                                "yyyy-MM-dd hh:mm:s"
                            );
                        }
                        return h("div", temp);
    ...
    methods: {
        ...
        queryConditions() {
            ...
            PatrolService.patrolTasksDatagrid(info).then(
                result => {
                    this.patrolTask = result.list;
        ...
        goToMoudle2: function(index, type) {
            sessionStorage.setItem("detailId", this.patrolTask[index].id);
            this.$router.push({
                name: "添加巡检任务",
                params: {
        ...
        queryOneMonth(data) {
            ...
            PatrolService.patrolTaskMonth(timeInfo).then(
                result => {
