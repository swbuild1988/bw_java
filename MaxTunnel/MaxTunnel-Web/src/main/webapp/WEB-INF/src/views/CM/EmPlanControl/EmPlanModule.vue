        ...
        <Modal v-model="show.state" title="新增流程节点">
            <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="140">
                ...
                <FormItem label="节点名称" prop="taskKey">
                    <Select v-model="formValidate.taskKey" placeholder="请选择节点名称" class="InputWidth"
                ...
                <FormItem label="目标对象" prop="targetValue">
                    ...
                    <Select v-model="formValidate.targetValue" placeholder="请选择目标对象" class="InputWidth"
                    ...
                    <Poptip placement="bottom" width="1000" v-if="formValidate.targetKey == 1">
                        <Input v-model="formValidate.targetValue" placeholder="请选择目标对象" style="width:294px" />
                        <div class="pop" slot="content">
                            <meas-obj-choose v-on:objsChoose="getObjs" v-bind="measObj"></meas-obj-choose>
                        </div>
                    </Poptip>
                    <Input style="width:294px" v-model="formValidate.targetValue"
                        v-if="formValidate.targetKey == 0" />
                </FormItem>
                ...
                <FormItem label="行为所需结果" prop="actionValue" v-show="formValidate.actionKey == 3">
                    <Select v-model="formValidate.actionValue" placeholder="请选择应急行为所需结果" class="InputWidth">
                        <Option v-for="item in actionValueEnums" :value="item.val+''" :key="item.key">{{item.key}}
                        </Option>
                    </Select>
                </FormItem>
