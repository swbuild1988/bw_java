  ...
  <div>
    <div class="dataContainer1">
      ...
      <div class="linechart">
        ...
        <!-- <LineChart :style="{height:'35vh',width:'90%'}" v-bind="lineChart" ref="childChart"></LineChart> -->
...
export default {
  ...
  data() {
    return {
        ...
        periodList: [],
        // pieChart:{
        //   requestUrl: "tunnels/energies-det/ratio",
        //   id: "pie",
        //   params:{
        //     id: 1,
        //     startTime: null,
        ...
        lineChart: {
          ...
          params:{
            id: 1,
            startTime: 1532522357127,
            endTime: 1535114357127
          },
  ...
  methods: {
      ...
      energyConsumptionService.getECCategory(params).then(
        (result)=>{
          ...
          result.forEach((cat,index) => {
            let colorIndex = (index + _this.colors.length) % _this.colors.length
            let temp = {}
    ...
    fetchData() {
      let option = {
        ...
        let _this = this
        energyConsumptionService.getECCategoryDetail(_this.query.id,_this.period).then(
          (result)=>{
              let serises = []
              _this.legendData = []
              let XCategory = []
