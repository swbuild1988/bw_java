        ...
        <Row class="content">
            ...
            <div class="control">
                ...
                <Row class="controlBody" style="height: 20vh">
                    ...
                    <div class="controlContent">
                        <video-control @startDirectCtrl="start" @stopDirectCtrl="stop" v-bind:isDisabled="isDisabled">
                        </video-control>
                    </div>
                    </Col>
                </Row>
            ...
            <div class="lists">
                ...
                <div style="height: 90%;" class="controlBody">
                    ...
                    <p v-if="curVideo">{{ curVideo.tunnelName + ' ' + curVideo.areaName + ' ' + curVideo.storeName }}
                    </p>
            ...
            <div class="scenesList">
                ...
                <div class="more">
                    <Poptip placement="left">
                        ...
                        <div class="api" slot="content">
                            <Icon class="screens" type="android-checkbox-outline-blank"
                                @click.native="handleScreensNum(1)"></Icon>
                ...
                <Row style="width: 94%;margin-left: 3%;">
                    ...
                    <div class="videos">
                        ...
                        <Row>
                            <Col :span="videoNum == 4 ? 12 : (videoNum == 1 ? 24 : 8)"
                                v-for="(item,index) in showVideosList" :key="item.id"
                                :class="['monitors',{'active': curVideo && item.id == curVideo.id},{'oneSBody': videoNum == 1},{'nineSBody': videoNum == 9}]">
                            <div @click="selectScene(item)">
                                <div :class="['monitor',{'oneScreen':videoNum == 1},{'nineScreen': videoNum == 9}]"
                                    v-if="videoStyle.show">
                                    <video-component :index="index" v-bind:video="item" v-bind:id="'camera'+item.id">
                                    </video-component>
                                </div>
                                <div class="options">
                    ...
                    <Icon type="chevron-right"
                        ...
                        @click.native="pageChange('next')" @mousedown.native="down('next')"
                        @mouseup.native="up('next')"></Icon>
                    </Col>
                </Row>
            </div>
            </Col>
