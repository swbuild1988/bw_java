        ...
        <div class="conditions">
            <Row>
                <Col span="5">
                    ...
                    <Input
                        v-model="conditions.documentName"
                        placeholder="请输入文件名称"
                        style="width: 60%"
                    />
                </Col>
                ...
                <Col span="2">
                    <Button
                        ...
                        class="del"
                    >删除</Button>
                    <Button type="primary" @click="del" v-if="showCheckBox" class="confirm">确认</Button>
                    <Button type="ghost" @click="cancel" v-if="showCheckBox" class="cancel">取消</Button>
                </Col>
            </Row>
        </div>
        <div class="list">
            <div class="nullData" v-show="isNullData">
                <span>暂无数据</span>
            </div>
            <Row>
                    ...
                    <div class="fileItem">
                        ...
                        <div class="operations">
                            <Tooltip content="下载">
                                <!-- Chrome -->
                                <a
                                    :href="'/'+ApiUrl.split('/')[3]+'/files/download/' + file.id"
                                    :download="file.name"
                                    v-if="!IEbrowser"
                                >
                                    <Icon
                                ...
                                <!--  IE -->
                                <Icon
                                    :type="isLoading && file.id == curFile ? 'load-c' : 'android-download'"
                                    color="#49d9fe"
                                    size="30"
                                    @click.native="download(file.id,file.name)"
                                    :class="[{'download': !isLoading},{'demo-spin-icon-load': isLoading && file.id == curFile}]"
                                    v-if="IEbrowser"
                                ></Icon>
                            </Tooltip>
                        </div>
