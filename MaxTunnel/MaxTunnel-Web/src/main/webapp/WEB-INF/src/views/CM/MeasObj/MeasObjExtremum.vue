	...
	<div>
		...
		<Modal v-model="modal.isShow" :title="modal.title" @on-cancel="handleReset()" :mask-closable="false">
			<Form ref="unitParam" :model="modal.info" :label-width="120">
				...
				<FormItem label="显示类型：0 原值；1 正常范围内随机；2 显示值；3 自定义" prop="showType">
				...
				<FormItem label="自定义最小值：" prop="custMin">
					<Input v-model="modal.info.custMin" type="number" />
				</FormItem>
				<FormItem label="自定义最大值：" prop="custMax">
					<Input v-model="modal.info.custMax" type="number" />
				</FormItem>
			</Form>
			<div slot="footer">
