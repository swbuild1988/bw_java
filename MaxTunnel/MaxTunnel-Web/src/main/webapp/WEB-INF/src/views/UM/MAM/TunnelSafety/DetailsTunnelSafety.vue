        ...
        <tabs :tabList="tabs.tabList" :tabIndex="tabsIndex" @changeTab="changeTabs">
            <Row :gutter="16" v-show="isShowComponent">
                        ...
                        <div class="screenNumChange">
                            <Poptip placement="left">
                                ...
                                <div class="api" slot="content">
                                    ...
                                    <Icon class="screens" type="android-apps" @click.native="handleScreensNum(9)">
                                    </Icon>
                                </div>
                            </Poptip>
                        </div>
                ...
                <Row :gutter="16" style="margin-right: 2px;">
                    ...
                    <show-obj-data v-bind:Obj="item" @changeStatus="changeStatus" @changeView="setView"
                        @getSwicthState="changeSwicthState" @reset="reset"></show-obj-data>
                    </Col>
                </Row>
                </Col>
            </Row>
