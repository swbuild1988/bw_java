...
export default {
    ...
    methods: {
        ...
        goToMoudle2: function(index, type) {
            sessionStorage.setItem("pageType", Enum.pageType.Read);
            sessionStorage.setItem("detailId", this.defects[index].id);
            this.$router.push({
                name: "缺陷详情",
                params: {
                    id: this.defects[index].id,
