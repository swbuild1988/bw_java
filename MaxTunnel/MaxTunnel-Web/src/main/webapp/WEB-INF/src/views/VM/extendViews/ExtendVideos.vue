<template>
    <div class="extendVideos BackgroundImage">
        <Carousel autoplay v-model="loopSetting.defaultLoopIndex" :dots="loopSetting.dots"
            :autoplay-speed="loopSetting.autoplaySpeed" :loop="loopSetting.loop">
            <CarouselItem v-for="(val,key) in loopSceneVideos" :key="key">
                <div class="extendView" :style="{height:videoStyle.height+'px',width:videoStyle.width+'px'}"
