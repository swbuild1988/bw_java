        ...
        <Row class="body">
            ...
            <div class="query" v-if="route.queryShow">
                <Row>
                    ...
                    <Select v-model="route.curRoute" @on-change="getCurRoute(0)">
                        <Option v-for="route in route.list" :key="route.id" :value="route.id">{{ route.name }}</Option>
                    </Select>
                    </Col>
                </Row>
            </div>
            ...
            <div class="cameras">
                <Row>
                    ...
                    <Col span="22">
                    <div class="videos">
                        <h1 v-if="cameras.nodata"
                            style="text-align: center;margin-top: 2vmin;color:#fff;font-size: 2vmin;">暂无视频</h1>
                        <Row>
                            <Col span="12" v-for="(item,index) in cameras.showList" :key="item.id">
                            <div class="monitors">
                                <video-component v-bind:video="item" v-bind:id="'camera'+item.id" :index="index">
                                </video-component>
                            </div>
                            </Col>
                        </Row>
                    ...
                    <Col span="1" class="slipContent">
                    <Icon type="arrow-right-b" :class="['slipRight',{'disabled' : cameras.curPage == cameras.totalPage},
