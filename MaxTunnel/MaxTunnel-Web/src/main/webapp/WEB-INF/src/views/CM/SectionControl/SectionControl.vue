...
export default {
                ...
                if(code == 200){
                    ...
                    for( let index in data.list) {
                        ...
                        if(data.list[index].totalCableNumber != null){
                            info.totalCableNumber = data.list[index].totalCableNumber;
                        };
                        if(data.list[index].store !=null && data.list[index].store.tunnel != null){
                            info.tunnelName = data.list[index].store.tunnel.name;
    ...
    components:{
        BarnChoose,SectionModule,SectionModification
    }
}
</script>
