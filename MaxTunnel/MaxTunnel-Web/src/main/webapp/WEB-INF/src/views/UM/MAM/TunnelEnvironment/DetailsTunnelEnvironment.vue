        ...
        <tabs :tabList="tabs.tabList" :tabIndex="tabsIndex" @changeTab="changeTabs">
            <Row :gutter="16" v-show="isShowComponent">
                        ...
                        <div class="screenNumChange">
                            <Poptip placement="left">
                                ...
                                <div class="api" slot="content">
                                    ...
                                    <Icon class="screens" type="social-windows" @click.native="handleScreensNum(4)">
                                    </Icon>
                                    <Icon class="screens" type="android-apps" @click.native=" (9)"></Icon>
                                </div>
                            </Poptip>
                        </div>
                    </div>
                ...
                <Row :gutter="16" style="margin-right: 2px;">
                    <Col :span="queryCondition.curDataType == 30 ? '12' : '8'" v-for="item in Obj" :value="item.name"
                        :key="item.id">
                    <show-obj-data v-bind:Obj="item" :objTypeId="queryCondition.curDataType"
                        @getSwicthState="changeSwicthState" @changeStatus="changeStatus" @changeView="setView">
                    </show-obj-data>
                    </Col>
                </Row>
                </Col>
