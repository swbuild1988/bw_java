        ...
        <Row>
            <Col span="12" offset="1">
                <div class="cameraList">
                    ...
                    <Select
                        v-model="curVideo.areaId"
                        id="cameras"
                        @on-change="getCameras"
                        class="select"
                        placeholder="请选择区域"
                    >
                        <Option
                ...
                <div class="camera">
                    <video-component v-bind:video="curVideo" :id="'positionSetting'+curVideo.id"></video-component>
                </div>
            </Col>
            <Col span="9" offset="1">
                <Row class="controls">
...
export default {
    ...
    methods: {
        getAreaAndStores() {
            let _this = this;
            Promise.all([
                TunnelService.getStoresByTunnelId(this.curVideo.tunnelId),
                TunnelService.getAreasByTunnelId(this.curVideo.tunnelId)
            ]).then(
                result => {
        ...
        back() {
            this.$router.push(
                "/UM/VideoMonitoring/details/" + this.curVideo.tunnelId
            );
        },
        start(data) {
            let _this = this;
