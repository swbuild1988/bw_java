    ...
    <div>
        <div style="margin: 1vh;">
            <RadioGroup v-model="queryCondition.areaId" type="button" @on-change="updateArea" size="large"
                class="stores">
                <Radio v-for="(item) in areaList" :key="item.id" :label="item.id"
        ...
        <Row>
            ...
            <div class="gis" :style="{height:curHeight+'px'}">
                ...
                <div class="positionNote" v-if="note.areaName && note.storeName">
            ...
            <div :style="{height:curHeight+'px'}" class="overview-context">
                ...
                <div class="borde_rhadow monitor-tunnel-number"
