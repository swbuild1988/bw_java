                        ...
                        TunnelService.getVmLineMessage().then(
                            result => {
                                ...
                                tempData.forEach(line => {
                                    ...
                                    _this.serises.push(parseInt(line.percent.slice(0, line.percent.length -
                                        1)));
                                })
                    ...
                    _this.axios.get(requestUrl).then(result => {
                        ...
                        if (code == 200) {
                            ...
                            data.forEach(a => {
                                ...
                                temp.data = tempData;
                                _this.yMin = (Math.min.apply(null, tempData) < _this.yMin || _this
                                    .yMin == 0) ? Math.min.apply(null, tempData) : _this.yMin;
