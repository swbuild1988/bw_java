...
export default {
    ...
    methods: {
        init() {
            this.drawLine(this.parameters.title, this.XCategory);
            this.fetchData(this.requestUrl, this.parameters.title.titleColor);
            this.refreshData();
        },
        drawLine(title, XCategory) {
            let _this = this;
            let titleName = title.titleName;
            let titleColor = title.titleColor;
            let titleFontSize = title.titleFontSize;
