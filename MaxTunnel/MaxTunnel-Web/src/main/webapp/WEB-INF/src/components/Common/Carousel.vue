<template>
    <div class="videosContent">
        ...
        <Row style="height: 100%">
            ...
            <Col v-else :span="videoNumber === 1 ? '24' : ( videoNumber === 4 ? '12' : '8')"
                v-for="(video,index) in curVideoList" :key="video.id" :style="{height: wrapperHeight}">
            <div :class="['videoWrapper',{'oneVideo' : videoNumber === 1}]">
                <video-component :index="preIndex+index" :video="video" :id="'curLoopSceneVideo'+video.id">
                </video-component>
            </div>
            </Col>
        </Row>
