            ...
            <div v-for="(item,index) in leftTree" :key="item.key">
              <div v-if="item.childNode && item.childNode.length>0">
                <Submenu :name="'1-'+ index">
                  ...
                  <MenuItem v-for="(child,childIndex) in item.childNode" :key="child.id" :name="'1-'+index+'-'+ childIndex"
                    @click.native="goToMoudle({ path:child.url},index,childIndex)" :class="{itemActive:(index==selectedActive[0] &&　childIndex == selectedActive[1])}">
              ...
              <div class="unitBox">
                ...
                <div class="contact">
                  <div class="contactName">
                    <span><Icon type="stats-bars" style="font-size: 1.5vmin"></Icon></span>
                    <span>{{item.alarmLevel}}</span>
                  </div>
                  <div class="contactTel">
                    <span><Icon type="ios-pricetags" style="font-size: 1.5vmin"></Icon></span>
                    <span>{{item.relatedObjectName}}</span>
                  </div>
                  <div class="sections">
                    <span><Icon type="document-text" style="font-size: 1.5vmin"></Icon>
                      </Icon></span>
                    {{item.description}}
                  </div>
                </div>
                <div class="option">
                  ...
                  <div class="crtTime">
                    <span>
                      <Icon type="android-time"></Icon>{{item.alatmTime}}
                    </span>
                  </div>
                </div>
              </div>
