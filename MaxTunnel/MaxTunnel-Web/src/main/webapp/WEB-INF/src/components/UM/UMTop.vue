<template>
    <Layout>
                    ...
                    <div style="position: absolute;right: 18vmin;height:6%">
                        ...
                        <Dropdown placement="bottom-start">
                            ...
                            <DropdownMenu slot="list" :id="module.id">
                                <DropdownItem v-for="child in module.children" :key="child.name" :name="child.name"
                                    divided :disabled="findPath(child.path)?false:true"
                                    @click.native="goToMoudle({ path: child.url})">{{child.name}}</DropdownItem>
                            </DropdownMenu>
                        </Dropdown>
                        </MenuItem>
                    </div>
                        ...
                        <Dropdown>
                            <a href="javascript:void(0)" class="outBox">
                                <Badge :count="countNum">
                                    <Avatar :style="{background:'#f56a00'}" size="large" shape="circle" :src="umImg">
                                    </Avatar>
                                </Badge>
                            </a>
                            <DropdownMenu slot="list" class="info-person">
                                <DropdownItem @click.native="goToMoudle({ path: '/UM/myNews/queryMyTask'})">我的消息
                                </DropdownItem>
                                <!-- <DropdownItem @click.native="goToMoudle({ path: '/UM/myApplication/query'})">我的申请</DropdownItem> -->
                                <DropdownItem @click.native="goToMoudle({ path: '/UM/myTasks/query'})">
                                    我的任务
                                    <span>（{{messageCount}}）</span>
                                </DropdownItem>
                                <DropdownItem @click.native="showAboutUs">关于我们</DropdownItem>
                                <showAboutUs v-bind="aboutUs"></showAboutUs>
                                <DropdownItem @click.native="goToMoudle({ path: '/UM/personCenter/editPass'})">个人中心
                                </DropdownItem>
        ...
        <showAlarm :modalPrams="videoModal.modalPrams" :alarmContainer="videoModal.alarmContainer" ref="video">
        </showAlarm>
    </Layout>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            cleanAlarm(id) {
                ...
                DataAnalysisService.clearAlarms(param).then(
                    result => {
