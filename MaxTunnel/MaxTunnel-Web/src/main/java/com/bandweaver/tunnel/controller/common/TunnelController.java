...
public class TunnelController extends BaseController<Tunnel> {
     ...
     * @date 2018年6月28日
     */
    @RequestMapping(value = "tunnels/{tunnelid}/max-cv", method = RequestMethod.GET)
    public JSONObject getMaxCVByTunnelId(@PathVariable("tunnelid") Integer tunnelid) {

        // 获取tunnelId=？的measobjId集合
        List<MeasObjAI> measObjAIList = measObjModuleCenter.getMeasObjAIs().stream()
